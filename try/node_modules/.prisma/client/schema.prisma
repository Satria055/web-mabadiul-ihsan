...
generator client {
  ...
  engineType    = "binary"
  // EL9 butuh 'rhel-openssl-3.0.x'. Kita masukkan semua opsi agar aman.
  binaryTargets = ["native", "rhel-openssl-3.0.x", "rhel-openssl-1.0.x", "debian-openssl-1.1.x", "linux-musl"]
}
