  ...
  return (
    <div className="max-w-7xl mx-auto pb-20">
      <div className="flex items-center justify-between mb-6">
        ...
        <h1 className="text-2xl font-serif font-bold text-gray-800">Input Prestasi Baru</h1>
      </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm space-y-6">
              <div>
                ...
                <input type="text" name="title" required className="w-full text-2xl font-serif font-bold text-gray-800 placeholder-gray-300 border-none focus:ring-0 p-0 outline-none" placeholder="Contoh: Juara 1 OSN Matematika..." />
              </div>
              <div>
                 <label className="block text-sm font-bold text-gray-700 mb-3 flex items-center gap-2">
                    <AlignLeft size={18} className="text-maroon-primary"/> Cerita / Deskripsi
                 </label>
                 <textarea name="description" rows={8} className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-maroon-primary outline-none leading-relaxed" placeholder="Ceritakan bagaimana prestasi ini diraih..."></textarea>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                 ...
                 <input type="text" name="student" required className="w-full px-4 py-2.5 rounded-lg border border-gray-300 outline-none" />
              </div>
              <div>
                 <label className="text-sm font-bold text-gray-700 mb-2 flex items-center gap-2">
                    <Calendar size={18} className="text-gray-400" /> Waktu Perolehan
                 </label>
                 <input type="text" name="date" placeholder="Contoh: Januari 2024" required className="w-full px-4 py-2.5 rounded-lg border border-gray-300 outline-none" />
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm sticky top-6 z-10">
              ...
              <button type="submit" disabled={loading} className="w-full bg-maroon-primary text-white py-3 rounded-lg font-bold hover:bg-maroon-dark transition-all disabled:opacity-70 flex items-center justify-center gap-2">
                {loading ? <Loader2 className="animate-spin" size={20}/> : "Terbitkan Prestasi"}
              </button>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm space-y-4">
              ...
              <div>
                ...
                <select name="rank" className="w-full px-3 py-2 rounded-lg border border-gray-300 bg-gray-50 outline-none">
              ...
              <div>
                ...
                <select name="category" className="w-full px-3 py-2 rounded-lg border border-gray-300 bg-gray-50 outline-none">
              ...
              <div>
                ...
                <div className="relative">
                  <input type="text" name="level" placeholder="Misal: Tingkat Kabupaten" required className="w-full px-3 py-2 pl-9 rounded-lg border border-gray-300 outline-none" />
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
              ...
              <div className="relative">
                ...
                <div className={`border-2 border-dashed border-gray-300 rounded-lg p-6 flex flex-col items-center justify-center bg-gray-50 hover:bg-gray-100 transition-colors cursor-pointer text-center relative h-40 ${preview ? 'hidden' : 'flex'}`}>
                  ...
                  <span className="text-sm font-bold text-gray-600">Upload Foto</span>
                </div>
              </div>
            </div>
