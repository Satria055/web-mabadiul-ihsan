...
import { getPageMeta } from "@/lib/page-meta"; // Helper Banner Dinamis
import Link from "next/link";
import { ArrowRight, Globe, BookOpen } from "lucide-react";

export default async function PendidikanNonFormalPage() {
  // 1. Ambil Data Banner Dinamis (Slug: 'pendidikan-non-formal')
  const meta = await getPageMeta("pendidikan-non-formal", "Pendidikan Non Formal");

  // 2. Ambil Data Unit (Filter: category contains "Non")
      ...
      <section className="py-20 bg-gray-50 min-h-[60vh]">
        <div className="container-custom">
          ...
          <div className="mb-8 flex items-center gap-2 text-sm text-gray-500">
             ...
             <span>Menampilkan <strong>{units.length}</strong> program non-formal</span>
          </div>
          ...
          {units.length === 0 ? (
            <div className="text-center py-24 bg-white rounded-3xl border border-dashed border-gray-200">
               ...
               <h3 className="text-lg font-bold text-gray-600">Program Belum Tersedia</h3>
               <p className="text-gray-400 italic">Data pendidikan non-formal sedang disiapkan oleh admin.</p>
            </div>
          ) : (
              ...
              {units.map((unit) => (
                ...
                >
                  ...
                  <div className="h-60 w-full relative bg-gray-100 overflow-hidden">
                    <img
                      src={unit.image || "https://placehold.co/600x400?text=Non+Formal"}
                      alt={unit.name}
                  ...
                  <div className="p-7 flex flex-col flex-grow relative">
                    ...
                    <div className="flex items-center justify-between mt-auto">
                      ...
                      {unit.link ? (
                        ...
                        <span className="text-xs text-gray-300 italic">Program Internal</span>
                      )}
