...
export default async function PesantrenPage() {
  // 1. Ambil Data Banner Dinamis (Slug: 'pesantren')
  // Default title: "Pondok Pesantren" jika belum ada di DB
  const meta = await getPageMeta("pesantren", "Pondok Pesantren");

  // 2. Ambil Data Unit (Filter: category contains "Pesantren")
      ...
      <section className="py-20 bg-gray-50 min-h-[60vh]">
        <div className="container-custom">
          ...
          <div className="mb-8 flex items-center gap-2 text-sm text-gray-500">
             ...
             <span>Menampilkan <strong>{units.length}</strong> unit pesantren</span>
          </div>
          ...
          {units.length === 0 ? (
            <div className="text-center py-24 bg-white rounded-3xl border border-dashed border-gray-200">
               ...
               <p className="text-gray-400 italic">Admin belum menginput data pondok pesantren.</p>
            </div>
          ) : (
              ...
              {units.map((unit) => (
                ...
                >
                  ...
                  <div className="h-60 w-full relative bg-gray-100 overflow-hidden">
                    <img
                      src={unit.image || "https://placehold.co/600x400?text=Pesantren"}
                      alt={unit.name}
